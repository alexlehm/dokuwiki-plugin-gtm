...
class action_plugin_googletagmanager extends ActionPlugin
{
    ...
    {
        return ['author' => 'Alexander Lehmann', 'email'  => 'alexlehm@gmail.com', 'date'   => '2026-01-03', 'name'   => 'Google Tag Manager Plugin', 'desc'   => 'Plugin to embed Google Tag Manager in your wiki.', 'url'    => 'https://wiki.lehmann.cx/projects:dokuwiki_gtm'];
    }
